...
<div class="row row-content">
    <div class="col-sm-2" id="tcards">
        <tcards></tcards>
    </div>
    <div class="col-sm-7" id="newsfeed">
        
        <tnews-feed ng-hide="tsub"></tnews-feed>
...
<!--FILES END-->   
 ...
 <div class="col-sm-3">
            ...
            <ul class="list-group">
                <li class="list-group-item list-group-item-info learnest-logo  black-label"><center>Top 10 Uploaders </center></li>                
  <li class="list-group-item justify-content-between" ng-repeat="x in top10">
      ...
      {{x.branch}}
<span class="badge badge-default badge-pill">{{x.rep}}</span>
</li>
